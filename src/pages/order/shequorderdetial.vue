<template>
  <div class="contain">
    ...
    <div class="orders">
      ...
      <div
        class="user_coupon"
        v-if="state2 == 2||state2 == 3 || state2 == 4 || state2 == 5 ||state2 == 8 || state2 == 9"
      >
        <span>付款时间</span>
        <div class="c_coupon">
      ...
      <div
        class="user_coupon"
        v-if=" state2 == 5 ||  state2 == 7 || state2 == 8 || state2 == 9"
      >
        <span>确认收货时间</span>
        <div class="c_coupon">
    ...
    <div class="sure" v-if="state2 == 3" @click="shou">确认收货</div>
    <div class="sure" v-if="state2 == 5 && show==true"  @click="del">删除订单</div>
    <div class="sure" v-if="state2 ==6 ||state2 ==8" @click="del">删除订单</div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    checkComment() {
      wx.navigateTo({
        url: "/pages/order/goodPingDetails?id=" + this.id
      });
    },
    goLogistic(i) {
      let obj = {};
